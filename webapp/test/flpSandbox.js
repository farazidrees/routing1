		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Routing",
									"targetURL": "#comsaprouting1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaprouting1-display": {
								"semanticObject": "comsaprouting1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.routing1",
									"url": sap.ui.require.toUrl("com/sap/routing1")
								}
							}
						}
					}
